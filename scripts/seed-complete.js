...
const seedData = async () => {
    try {
        ...
        // Create Categories
        const breakfastCat = await Category.create({
            name: 'Breakfast',
            slug: 'breakfast',
        ...
        const dessertCat = await Category.create({
            name: 'Desserts',
            slug: 'desserts',
        ...
        const beverageCat = await Category.create({
            name: 'Beverages',
            slug: 'beverages',
        ...
        const menuItems = [
            // Breakfast
            {
                ...
                price: 350,
                categoryId: breakfastCat._id,
                status: 'Active',
                restaurantId: restaurant1._id,
                image: 'https://images.unsplash.com/photo-1600080946577-3d79d8077b3f?w=300',
            },
            {
                name: 'Eggs Benedict',
            ...
            },
            {
                ...
                description: 'Fresh vegetable omelette with cheese',
                price: 300,
                categoryId: breakfastCat._id,
                status: 'Active',
                restaurantId: restaurant1._id,
                image: 'https://images.unsplash.com/photo-1585521537000-dd8e5d7a1f05?w=300',
            },
            // Main Course
            {
                name: 'Grilled Salmon',
            ...
            {
                name: 'Beef Steak',
                description: 'Prime cut beef steak with garlic mashed potatoes',
                price: 880,
                categoryId: mainCat._id,
                status: 'Active',
                restaurantId: restaurant1._id,
            ...
            },
            {
                ...
                status: 'Active',
                restaurantId: restaurant1._id,
                image: 'https://images.unsplash.com/photo-1682805589619-aa39db139f91?w=300',
            },
            // Desserts
            {
            ...
            },
            {
                ...
                status: 'Active',
                restaurantId: restaurant1._id,
                image: 'https://images.unsplash.com/photo-1585518419759-53b5aba1c97e?w=300',
            },
        ];
        ...
        for (let i = 1; i <= 12; i++) {
            tables.push({
                ...
                capacity: Math.ceil(Math.random() * 6) + 2, // 2-8 capacity
                status: 'AVAILABLE',
                restaurantId: restaurant1._id,
            });
        }
